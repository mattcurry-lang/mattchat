...
import { IconX, IconHeart, IconMessageSquare, IconBell, IconCheck } from '../Icons'
...
export default function TrustedPersonDashboard({ onOpenConversation, onClose }) {
  ...
  const [responding, setResponding] = useState(null) // link id currently being accepted/declined
