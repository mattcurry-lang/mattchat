            ...
            {table.map(row => {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.65)' }}>{row.played}</div>
                  <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.65)' }}>{row.won}</div>
                  <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.65)' }}>{row.draw}</div>
                  <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.65)' }}>{row.lost}</div>
                  <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.65)' }}>{row.goalDifference > 0 ? `+${row.goalDifference}` : row.goalDifference}</div>
                  <div style={{ fontSize: 13, fontWeight: 800, color: '#fff' }}>{row.points}</div>
                </div>
              )
            })}
          </div>
