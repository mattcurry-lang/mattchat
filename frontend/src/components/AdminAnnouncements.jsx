...
import { IconMail, IconX, IconCheckSquare, IconClock, IconShield } from './Icons'
  ...
  return (
    <div style={overlay} onClick={onClose}>
      <div style={card} onClick={e => e.stopPropagation()}>
        ...
        <div style={{ padding: '20px 22px', background: 'linear-gradient(135deg, rgba(102,126,234,0.15), rgba(118,75,162,0.15))', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: 10 }}>
