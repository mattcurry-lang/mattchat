...
const styles = {
  ...
  rippleWrap: { position: 'relative', width: 96, height: 96, marginBottom: 8 },
  ripple: {
  ...
  avatarCircle: {
    ...
    display: 'flex', alignItems: 'center', justifyContent: 'center',
    fontSize: 36, fontWeight: 700, color: '#fff', zIndex: 1,
  },
  callerName: { fontSize: 22, fontWeight: 700, color: '#fff', letterSpacing: '-0.4px', textAlign: 'center' },
  callType: { fontSize: 14, color: 'rgba(255,255,255,0.55)', fontWeight: 500, marginBottom: 8, textAlign: 'center', minHeight: 20 },
  btnRow: { display: 'flex', gap: 32, marginTop: 16 },
  declineBtn: {
    display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8,
    background: 'rgba(239,68,68,0.15)', border: '1px solid rgba(239,68,68,0.4)',
    borderRadius: 50, padding: '14px 24px', cursor: 'pointer', transition: 'all 0.15s',
    fontFamily: 'inherit',
  },
  answerBtn: {
    display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8,
  ...
  btnIcon: { fontSize: 28 },
  btnLabel: { fontSize: 12, fontWeight: 700, color: 'rgba(255,255,255,0.7)', textTransform: 'uppercase', letterSpacing: '0.06em' },
}
